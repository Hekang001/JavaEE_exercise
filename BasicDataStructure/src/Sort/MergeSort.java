...
public class MergeSort {
	...
	public MyArray<Integer> mergeSort(MyArray<Integer> array) {
		// 递归终止条件
		if (array.getSize() <= 1) {
			return array;
		}
		...
		// 左半部分进行拆分
		MyArray<Integer> leftArray = new MyArray<Integer>(mid);
		MyArray<Integer> rightArray = new MyArray<Integer>(mid);
		...
		int rightIndex = 0;
		// 进行合并
		MyArray<Integer> results = new MyArray<Integer>(2 * mid);
		int cnt = 0;
